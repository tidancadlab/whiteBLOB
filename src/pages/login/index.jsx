...
const LoginPage = () => {
  ...
  return (
    <div className="flex h-screen grow items-center justify-center bg-black px-1">
      <div className="w-80 scale-90 rounded-3xl bg-gray-950 p-8 text-white shadow-md duration-150 ease-in-out sm:w-[420px] sm:scale-100 sm:p-10">
        ...
        <button
          onClick={() => setIsRegistered((previous) => !previous)}
          type="submit"
          className="focus:shadow-outline-blue mt-4 w-full rounded bg-violet-500 p-2 text-white hover:bg-violet-600 focus:outline-none">
